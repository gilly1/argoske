...
use CrudGenerator\GeneratorException;
...
class SyntaxBuilder
{
    ...
    {
        return file_get_contents(__DIR__ . '/theStubs/schema-create.stub');
    }
    ...
    {
        return file_get_contents(__DIR__ . '/theStubs/schema-change.stub');
    }
