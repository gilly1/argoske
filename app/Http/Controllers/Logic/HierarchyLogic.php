...
class HierarchyLogic
{
    const route = 'hierarchies';
    const redirect = 'hierarchies/hierarchies';
    ...
    {    
        ...
        $values = [
			...
			'description'=>
			[
				'textarea','text','Description',12,true,true,'description','description','Enter Description'
			],
    ...
    {     
        ...
        $data = $this->model->select('name','description'
			)->get(); //variable
