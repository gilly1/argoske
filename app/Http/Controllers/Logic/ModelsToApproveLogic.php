...
class ModelsToApproveLogic
{
    const route = 'models_to_approves';
    const redirect = 'models_to_approves/models_to_approves';

    public $model;

    function __construct(
        ModelsToApprove $model
    ){
        $this->model = $model;
    }
