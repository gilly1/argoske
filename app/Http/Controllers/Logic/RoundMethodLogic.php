...
class RoundMethodLogic
{
    const route = 'round_methods';
    const redirect = 'round_methods/round_methods';
    ...
    {    
        ...
        $values = [
			...
			'function'=>
			[
				'text','string','Function',6,true,true,'function','function','Enter Function'
			],
    ...
    {     
        ...
        $data = $this->model->select('name','function'
			)->get(); //variable
